(()=>{
  ...
  const ensure=()=>{
    ...
    dialog.innerHTML=`<form method="dialog">
      ...
      </section><aside><strong>Sharing options</strong><label class="ds-share-switch-row"><span>Share system audio</span><input type="checkbox" role="switch" data-share-audio></label><label class="ds-share-switch-row"><span>Optimize for video sharing</span><input type="checkbox" role="switch" data-optimize></label><label class="ds-share-switch-row" hidden><span>Share DominionStar windows</span><input type="checkbox" role="switch" data-own-windows></label><p data-audio-note></p><small hidden>DominionStar windows stay private by default to prevent mirror recursion.</small></aside></main>
