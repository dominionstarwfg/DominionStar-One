...
assert(meetingFeatures.includes('state.recorder.pause()')&&meetingFeatures.includes('state.recorder.resume()')&&meetingFeatures.includes('recordingPaused:true')===false,'Recording must pause/resume the same MediaRecorder rather than creating a second recording file.');
