...
function brand(){
const h=q('#meetingOverlay .meeting-head');if(!h)return;
...
function sync(){
const o=q('#meetingOverlay');if(!o)return false;styles();o.classList.add('ds-exec-lock');brand();syncControls();requestAnimationFrame(()=>{brand();syncControls();});return true;
}
