...
assert(features.includes("version:'1.2.0'")&&features.includes('recordingAuthority()')&&features.includes("['host','cohost'].includes(role)||Boolean(participant?.recordingAllowed)"),'Packaged recording must enforce Zoom-style host/co-host or host-granted participant authority.');
