(()=>{
  ...
  install();
  window.DominionMeetingParity=Object.freeze({version:'2.5.0-zoom-host-view-control',install,toggleParticipants,syncVideoDock,resetVideoDock,syncMeetingMeta,setSpotlight,applyViewMode,syncShareLayout});
})();
