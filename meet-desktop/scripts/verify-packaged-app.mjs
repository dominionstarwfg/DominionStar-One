...
for(const script of ['./av-settings.js','./meeting-parity.js','./meeting-features.js','./zoom-behavior.js','./participant-controls.js','./preferences.js','./personal-room.js','./schedule-controller.js'])assert(html.includes(`<script src=\"${script}\"></script>`),`Packaged Home must load ${script}.`);
