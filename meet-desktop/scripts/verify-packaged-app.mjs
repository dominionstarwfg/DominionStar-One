...
assert(share.includes('sourceEnumerationInFlight'),'Packaged share authority must retain the single-flight anti-freeze guard.');
...
fs.rmSync(unpackDir,{recursive:true,force:true});
console.log('DOMINIONSTAR_PACKAGED_APP_CERTIFIED local-home pkce nonblocking-share webrtc diagnostics no-legacy-runtime');
