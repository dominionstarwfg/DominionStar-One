...
rm -f "$APP_LOG"
echo "Launching clean DominionStar Meet build against its bound QA runtime..."
...
echo "DOMINIONSTAR_MEET_CLEAN_APP_ACCEPTANCE_OK version=$VERSION bundle=$APP_ID archs=$ARCHS"
