...
#meetingOverlay.ds-exec-lock .meeting-control.ds-exec-control{position:relative!important;min-width:82px!important;width:auto!important;height:72px!important;margin:0!important;padding:7px 10px 8px!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:5px!important;border:0!important;border-radius:11px!important;background:transparent!important;color:#eef3fa!important;font-size:0!important;box-shadow:none!important}
...
#meetingOverlay.ds-exec-lock .ds-exec-icon{position:relative;width:29px;height:29px;display:grid;place-items:center;flex:none}
#meetingOverlay.ds-exec-lock .ds-exec-icon svg{width:28px;height:28px;fill:none;stroke:currentColor;stroke-width:1.75;stroke-linecap:round;stroke-linejoin:round;overflow:visible}
...
#meetingOverlay.ds-exec-lock #roomMic.is-off .ds-exec-icon::after,#meetingOverlay.ds-exec-lock #roomCamera.is-off .ds-exec-icon::after{content:"";position:absolute;left:2px;right:2px;top:13px;height:2.4px;border-radius:999px;background:#ff4261;transform:rotate(-42deg);box-shadow:none!important}
