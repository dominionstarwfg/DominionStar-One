...
// Zoom presenter-state contract: during an active share the normal meeting is
// hidden by default. A separate floating toolbar remains accessible above the
// presented application and owns Stop Share. Showing the meeting is explicit.
