...
assert(shareService.includes('if(toolbarWindow&&!toolbarWindow.isDestroyed()){toolbarWindow.showInactive();publishToolbarState();return;}'),'Packaged presenter toolbar must remain single-instance across source changes.');
