...
try{
  ...
  assert.ok(participantPanelGeometry.rightGap>=8&&participantPanelGeometry.rightGap<=16,'Participants must open at one stable Zoom-style right-edge position.');
