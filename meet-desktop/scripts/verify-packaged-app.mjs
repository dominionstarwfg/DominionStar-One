...
assert(captions.includes("version:'1.0.0'")&&captions.includes("button.id='roomCaptions'")&&captions.includes("caret.id='roomCaptionsMenu'"),'Packaged toolbar must expose Show/Hide Captions and caption options.');
