...
if (!main.includes('availableDisplaySources')) throw new Error('Missing stable native display-source cache');
if (!main.includes("process.platform === 'win32'")) throw new Error('Missing platform-safe system-audio gate');
