...
assert(js.includes("requestAnimationFrame(()=>requestAnimationFrame(normalizeParticipantPanel))"),'Participants click reconciliation must win after legacy panel positioning executes.');
...
assert(js.includes("version:'1.3.0'"),'Production polish module version must be explicit.');

console.log('DOMINIONSTAR_ZOOM_PRODUCTION_POLISH_OK readable-toolbar left-audio right-end green-share host-tools participant-search participants-right runtime-right-authority zoom-roster zoom-chat chat-race-safe readable-contrast left-rising-reactions permission-recheck stable-reconciliation');
