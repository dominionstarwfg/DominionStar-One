(()=>{
  ...
  install();
  window.DominionMeetingParity=Object.freeze({version:'2.6.0-live-shell-zoom-parity',install,toggleParticipants,syncVideoDock,resetVideoDock,syncMeetingMeta,setSpotlight,applyViewMode,syncShareLayout});
})();
