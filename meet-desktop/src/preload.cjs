...
contextBridge.exposeInMainWorld('dominionDesktop',Object.freeze({
  ...
  meeting:Object.freeze({
    ...
    setCohost:(participantId,enabled)=>invoke('meeting:set-cohost',{participantId,enabled}),
    removeParticipant:participantId=>invoke('meeting:remove-participant',{participantId}),
