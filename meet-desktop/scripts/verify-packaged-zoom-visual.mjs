...
try{
  ...
  assert.equal(reactIcon.marker,'executive-smile','React must use the canonical smile-and-spark toolbar icon.');
  assert.equal(reactIcon.svg,1,'React must render one toolbar glyph only.');
  assert.ok(reactIcon.paths>=2&&reactIcon.circles>=1,'React smile-and-spark glyph is incomplete.');
