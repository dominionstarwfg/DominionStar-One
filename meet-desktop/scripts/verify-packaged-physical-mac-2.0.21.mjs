...
try{
  ...
  console.log('DOMINIONSTAR_PACKAGED_PHYSICAL_MAC_2_0_21_OK repair-loaded adaptive-loaded native-share-entry recovery-not-preemptive adhoc-not-certified actual-personal-ui-authority reaction-contained settings-aligned actual-participant-count deterministic-speaker-threshold video-tile-real-mouse-drag normal-arrow-no-grip');
