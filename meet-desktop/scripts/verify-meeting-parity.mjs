...
assert(captions.includes("version:'1.1.0'")&&captions.includes("button.id='roomCaptions'")&&captions.includes("caret.id='roomCaptionsMenu'"),'Meeting toolbar must expose Show/Hide Captions with a Zoom-style options caret.');
...
console.log('DOMINIONSTAR_MEETING_PARITY_OK zoom-full-stage separate-participants adaptive-video-dock count-aware-grid active-speaker credentials real-logo responsive atomic-host-handoff admit-all private-chat unread-chat chat-policy participant-media-controls mute-all ask-unmute stop-video ask-start-video raise-hand lower-hand lower-all-hands zoom-standard-reactions reaction-10s identity-reactions captions manual-captioner transcript-separation caption-accessibility caption-popout bounded-sync adaptive-views gallery multi-speaker responsive-dock side-by-side-share draggable-divider hide-video-panel host-view-broadcast spotlight-side-by-side');
