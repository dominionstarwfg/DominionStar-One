...
assert(migration.includes('meet_v2_publish_caption')&&migration.includes("v_room.caption_mode<>'manual' or v_room.captioner_participant_id<>v_participant.id"),'Only the assigned manual captioner may publish caption text.');
