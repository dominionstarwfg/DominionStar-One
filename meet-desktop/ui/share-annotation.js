(()=>{
  ...
  window.DominionShareAnnotation=Object.freeze({version:'1.2.0',activate,deactivate,toggle,clear,undo,redo,setMode,snapshot:()=>({active:state.active,mode:state.mode,color:state.color,undoDepth:state.history.length,redoDepth:state.redo.length})});
})();
