...
for(const rpc of ['meet_v2_create_room','meet_v2_request_join','meet_v2_join_status','meet_v2_mark_joined','meet_v2_leave_room','meet_v2_host_queue','meet_v2_decide_participant','meet_v2_room_snapshot','meet_v2_set_cohost','meet_v2_remove_participant','meet_v2_end_room'])assert(service.includes(rpc),`Missing meeting RPC ${rpc}`);
...
console.log('DOMINIONSTAR_MEET_V2_LIFECYCLE_OK create prejoin join waiting admit decline cohost roster leave end isolated-no-share');
