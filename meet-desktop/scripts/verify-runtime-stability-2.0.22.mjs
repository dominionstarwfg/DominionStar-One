...
assert.ok(runtime.includes('function openRuntimeHostTools(anchor)')&&runtime.includes('void openRuntimeHostTools(hostTools)')&&!runtime.includes("DominionMeetingParity?.openSecurity?.(hostTools)"),'Host Tools must open through one runtime-owned single-click authority.');
