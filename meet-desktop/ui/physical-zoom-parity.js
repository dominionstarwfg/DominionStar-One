(()=>{
  ...
  function scheduleSync(){cancelAnimationFrame(raf);raf=requestAnimationFrame(()=>{normalizeToolbar();syncLocalProfile();syncRemoteProfiles();useNativeParticipants();dismissFalseInstallGate();bindMedia();});}
  ...
  window.DominionPhysicalZoomParity=Object.freeze({version:'1.1.0-native-participants',normalizeToolbar,syncLocalProfile,broadcastMediaState});
})();
