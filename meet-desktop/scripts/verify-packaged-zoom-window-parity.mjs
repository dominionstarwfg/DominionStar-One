...
try{
  ...
  console.log('DOMINIONSTAR_PACKAGED_ZOOM_WINDOW_PARITY_OK compact-prejoin one-person-floating real-input-drag merge-popout participant-priority search-when-useful adaptive-chat speaker-authority video-under3-hidden video-3plus-visible share-video-visible no-grip');
