(() => {
  ...
  const ready = Promise.all([
    annotation, verticalAnnotationUi, presenterCommandParity, microphoneIdentity, spotlight, handoff, arbitration, arbitrationUi,
  ...
  window.DominionOperation2030Bootstrap = Object.freeze({
    ...
    modules: Object.freeze([
      'share-annotation','annotation-vertical-ui','presenter-command-web-parity','microphone-device-identity','share-spotlight','presentation-handoff','share-arbitration','share-arbitration-ui',
