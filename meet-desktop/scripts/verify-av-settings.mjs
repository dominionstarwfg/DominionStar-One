...
console.log('DOMINIONSTAR_AV_SETTINGS_PARITY_OK devices quick-menus mirror original-ratio low-light-auto-manual touch-up portrait-lighting auto-framing background-blur video-denoise processed-outgoing-track quality clean-media-authority');
