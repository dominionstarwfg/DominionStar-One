...
assert(captions.includes("version:'1.1.0'")&&captions.includes("button.id='roomCaptions'")&&captions.includes("caret.id='roomCaptionsMenu'"),'Packaged toolbar must expose Show/Hide Captions and caption options.');
...
assert(captions.includes('Select manual captioner')&&captions.includes('meeting.setCaptionState')&&captions.includes('meeting.publishCaption'),'Packaged manual captioning must use server-backed assignment and publication authority.');
