...
assert(runtime.includes("handle.addEventListener('pointerdown',begin,true);")&&runtime.includes("handle.addEventListener('mousedown',begin,true);")&&runtime.includes("document.addEventListener('mousemove',move,true);")&&runtime.includes("document.addEventListener('mouseup',end,true);")&&!runtime.includes("surfaceDrag.source!==source"),'Final floating-panel drag authority must unify Pointer Events and Mac/Chromium mouse synthesis into one drag session.');
