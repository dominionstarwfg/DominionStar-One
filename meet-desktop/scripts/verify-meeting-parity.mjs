...
assert(captions.includes("version:'1.2.0'")&&captions.includes("button.id='roomCaptions'")&&captions.includes("caret.id='roomCaptionsMenu'"),'Meeting toolbar must expose Show/Hide Captions with a Zoom-style options caret.');
