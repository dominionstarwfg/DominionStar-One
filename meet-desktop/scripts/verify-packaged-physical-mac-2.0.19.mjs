...
try{
  ...
  // Use the application's actual participant roster and its owning panel. This
  // prevents duplicate-id fixtures from hiding panel/roster association bugs.
  ...
  console.log('DOMINIONSTAR_PACKAGED_PHYSICAL_MAC_2_0_19_OK repair-loaded explicit-tcc-recovery adhoc-not-certified actual-personal-ui-authority reaction-contained settings-aligned actual-participant-count');
